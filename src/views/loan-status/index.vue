<template>
    <div>
        <PageHeader
            title="Status de Empréstimos"
            subtitle="Gerencie os status disponíveis para empréstimos"
            :breadcrumbs="[{ label: 'Dashboard', to: '/dashboard' }, { label: 'Status de Empréstimos' }]"
        >
            <template #actions>

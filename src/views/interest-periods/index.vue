<template>
    <div>
        <PageHeader
            title="Períodos de Juros"
            subtitle="Gerencie os períodos de juros disponíveis para empréstimos"
            :breadcrumbs="[{ label: 'Dashboard', to: '/dashboard' }, { label: 'Períodos de Juros' }]"
        >
            <template #actions>

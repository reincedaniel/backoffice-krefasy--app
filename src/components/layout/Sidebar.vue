            ...
            <div class="bg-white dark:bg-[#0e1726] h-full">
                <div class="flex justify-between items-center px-4 py-3">
                    <router-link to="/" class="main-logo flex items-center shrink-0">
                        <img class="ml-[5px] flex-none" style="width: 8rem;" src="/assets/images/Krefasy.svg" alt="" />
                        <!-- <span class="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">KREFASY</span> -->
                    </router-link>
                    <a
                        href="javascript:;"

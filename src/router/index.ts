...
const routes: RouteRecordRaw[] = [
    ...
    // Krefasy Routes
    {
        path: '/auth/login',
        name: 'krefasy-login',
        component: () => import(/* webpackChunkName: "krefasy-login" */ '../views/auth/krefasy-login.vue'),
    ...
    {
        path: '/clients',
        name: 'krefasy-clients',
        component: () => import(/* webpackChunkName: "krefasy-clients" */ '../views/clients/krefasy-clients.vue'),
        meta: { requiresAuth: true, layout: 'app' }
    },
    {
        path: '/clients/:id',
        name: 'krefasy-client-detail',
        component: () => import(/* webpackChunkName: "krefasy-client-detail" */ '../views/clients/krefasy-client-detail.vue'),
        meta: { requiresAuth: true, layout: 'app' }
    },
    {
        path: '/loans',
    ...
    // invoice
    {
        ...
        name: 'invoice-list',
        component: () => import(/* webpackChunkName: "invoice-list" */ '../views/apps/invoice/list.vue'),
    },
    {
        path: '/apps/invoice/preview',
        name: 'invoice-preview',
        component: () => import(/* webpackChunkName: "invoice-preview" */ '../views/apps/invoice/preview.vue'),
    },
    {
        path: '/apps/invoice/add',
        name: 'invoice-add',
        component: () => import(/* webpackChunkName: "invoice-add" */ '../views/apps/invoice/add.vue'),
    },
    {
        path: '/apps/invoice/edit',
        name: 'invoice-edit',
        component: () => import(/* webpackChunkName: "invoice-edit" */ '../views/apps/invoice/edit.vue'),
    },
    {
        path: '/apps/calendar',
        name: 'calendar',
        component: () => import(/* webpackChunkName: "calendar" */ '../views/apps/calendar.vue'),
    },
